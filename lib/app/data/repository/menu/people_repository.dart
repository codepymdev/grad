...
class PeopleRepository {
  ...
  static Future<Map<String, dynamic>> deleteUser({
    ...
    var url = Uri.parse("${apiendpoint}people/delete/$school/$id/$type");
    try {
  ...
  static Future<Map<String, dynamic>> createUser(data) async {
    var url = Uri.parse("${apiendpoint}people/create");
    try {
  ...
  static Future<List<dynamic>> getClassStudents({
    ...
    var url = Uri.parse(
        "${apiendpoint}people/class-students/student/$classId/$school/$per_page/$page");
    try {
      var response = await client.get(url);
